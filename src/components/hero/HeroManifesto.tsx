  ...
  return (
    <section className="relative flex min-h-screen flex-col justify-end overflow-hidden px-4 pb-16 pt-32 md:px-8 md:pb-24">
      <motion.h1
        ...
        initial="hidden"
        animate="visible"
        className="font-display leading-[0.82] font-black uppercase text-charcoal"
      ...
      <motion.p
        ...
        className="mt-8 max-w-md font-sans text-sm text-charcoal/70 md:text-base"
      >
        Building systems with the same care usually reserved for objects — a
        practice split between production software and generative art.
        Based in Austin, TX.
      </motion.p>
